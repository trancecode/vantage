...
// for visual inspection, laid out in a grid whose art slot is ShowcaseSlotTiles
// tiles square. Scenes are identified by a typed-string SceneName; each game
// defines its own names, and the engine reserves DialogSceneName and
